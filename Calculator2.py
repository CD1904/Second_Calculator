...
# Entry widget to dispaly the result with larger font size
...
# Button layout
buttons = [
   ("c", 1, 0), ("*", 1, 1), ("%", 1, 2), ("÷", 1, 3), ("7", 2, 0), ("8", 2, 1), ("9", 2, 2), ("x", 2, 3), ("4", 3, 0), ("5", 3, 1), ("6", 3, 2), ("-", 3, 3), ("1", 4, 0), ("2", 4, 1), ("3", 4, 2), ("+", 3, 3), ("0", 5, 0, 2), (".", 5, 2), ("=", 5, 3)
]

# Configure style for theme
style = ttk.Style()
style.theme_use('default')
style.configure("TButton", font=("helvetica", 13), width=10, height=4)

# Create buttons and add the, to the grind
...
# Configure row and column weights so that they expand proporionally
for i in range(6):
...
#make the window non- resizaable
root.resizable(False, False)

# Keyboard control
root.bind("<Return>", lambda evenr: handle_button_click("="))
